...
<head>
     ...
     <link rel="stylesheet" type="text/css" href="estilos/estilos.css"><center><h1> Informacion y Registro de mpleados.
	...
	<form action="" method="post">
        ...
        <br> <link rel="stylesheet" type="text/css" href="estilos/estilos.css"><center><h4> Busqueda de Empleados.
    <p><font size="3" color="red">Ingresa el Codigo  y Nombre de Epleado para obtener informacion  sobre él.</font></p>
