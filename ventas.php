...
<head>
     ...
     <link rel="stylesheet" type="text/css" href="estilos/estilos.css"><center><h1> Relizar Ventas.
    
     <p><font size="3" color="red">LLene los campos correspondientes para completar la venta </font></p>
    
    
     <input type="text" name="fe" placeholder="Fecha de Venta" id="fe" oninput="validacion('fe')" required pattern="([A-Z ]{10,30})" maxlength="30"/><br>
     ...
     <input type="text" name="no" placeholder="Nombre Completo" id="ed" oninput="validacion('no')" required pattern="([0-9 ]{8,10})" maxlength="10"/><br>
    
     <input type="text" name="po" placeholder="Producto" id="po" oninput="validacion('po')" required pattern="([A-Z ]{10,30})" maxlength="30"/>
     
     <input type="text" name="pi" placeholder="Cantidad de Piezas" id="pi" oninput="validacion('pi')" required pattern="([A-Z ]{10,30})" maxlength="30"/><br>
