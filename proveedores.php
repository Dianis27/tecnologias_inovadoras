...
<head>
     ...
     <link rel="stylesheet" type="text/css" href="estilos/estilos.css"><center><h1> Informacion y Registro de Proveedores.
	...
	<form action="" method="post">
        ...
        <center><input type="submit" value="Guardar"/></center> 
         ...
         <br> <link rel="stylesheet" type="text/css" href="estilos/estilos.css"><center><h4> Busqueda de Proveedores.
        <p><font size="3" color="red">Ingresa el Codigo y el Nombre del proveedor para obtener informacion  sobre él.</font></p>
